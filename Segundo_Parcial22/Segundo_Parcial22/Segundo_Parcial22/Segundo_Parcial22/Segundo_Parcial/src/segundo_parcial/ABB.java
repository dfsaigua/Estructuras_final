...
public class ABB <T extends Comparable<T>>{
    ...
    public static ABB<String> cargarArbol(ABB<String> arbol){
        //ABB<String> arbol = new ABB();
        arbol.insertar("Decision43","BATLLA");
        arbol.insertar("Decision29","ATAQUE");
        arbol.insertar("Decision70","EXPLORAR");
        arbol.insertar("Decision25","ACCIONATAQUE");
        arbol.insertar("Decision33","ESPERAR");
        arbol.insertar("Decision60","MOVERSE");
        arbol.insertar("Decision75","ESPERAR");
        arbol.insertar("Decision15","ATAQUEDEBIL");
        arbol.insertar("Decision27","ATAQUEFUERETE");
       
        arbol.insertar("Decision55","MOVERSENORMAL");
        arbol.insertar("Decision65","MOVERSEMAS");
        arbol.insertar("Decision54","CORRER");
        arbol.insertar("Decision56","RETROCEDER");
        
        arbol.insertar("Decision64","SALTAR");
        arbol.insertar("Decision66","AGACHARSE");
        arbol.insertar("Decision14","PATADA");
        arbol.insertar("Decision16","PUÑETE");
        arbol.insertar("Decision26","LANZARPODER");
        arbol.insertar("Decision28","ESPERAR");
        return  arbol;
    }
